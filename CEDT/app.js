...
- แต่ละข้อมีตัวเลือก 4 ตัว ข้อถูกต้องมีเพียง 1 ตัวเลือก
- ห้ามสร้างคำถามซ้ำกัน แต่ละข้อต้องถามเรื่องคนละประเด็น

🎭 สไตล์คำถาม (บังคับ):
- คำถามต้องเป็นแบบ "สถานการณ์จำลอง" (Scenario-based) เท่านั้น
- ห้ามถามแบบท่องจำ เช่น "ข้อใดถูกต้อง" หรือ "ข้อใดคือความหมาย"
- ต้องมีบริบท สถานการณ์ หรือโจทย์ให้คิดวิเคราะห์ เช่น "ถ้านักเรียนเจอสถานการณ์...ควรทำอย่างไร"

🎯 การกระจายคำตอบถูก (บังคับ):
- ห้ามให้ correctIndex เป็นค่าเดียวกันติดกัน 3 ข้อขึ้นไป
- ต้องกระจาย correctIndex ให้หลากหลาย (0, 1, 2, 3 ผสมกัน)
- ห้ามให้ข้อถูกเป็นข้อเดียวกันเกิน 4 ข้อจาก 10 ข้อ
...
async function callGroqAPI(prompt) {
    const requestBody = {
        ...
        messages: [
            {
                role: 'system',
                content: `คุณเป็นผู้ช่วยสร้างข้อสอบเพื่อการศึกษาเท่านั้น

กฎจริยธรรม (สำคัญที่สุด):
- ห้ามสร้างเนื้อหาที่เกี่ยวกับความรุนแรง อาชญากรรม การทำร้าย สิ่งผิดกฎหมาย หรือเรื่องที่ขัดต่อศีลธรรม
- ถ้าผู้ใช้ขอเนื้อหาที่ไม่เหมาะสม ให้สร้างข้อสอบเรื่อง "ความปลอดภัยในชีวิตประจำวัน" แทน
- เนื้อหาต้องเป็นประโยชน์ต่อการเรียนรู้เท่านั้น

รูปแบบคำตอบ: ตอบเป็น JSON array เท่านั้น ห้ามเพิ่มข้อความอื่น ห้ามใส่ \`\`\`json หรือ \`\`\` ครอบ`
            },
            {
                role: 'user',
                content: prompt
